...
declare module '@poppinss/http-server/contracts' {
  ...
  > {
    ...
    route (pattern: string, methods: string[], handler: any): Route,
    any (pattern: string, handler: any): Route,
    get (pattern: string, handler: any): Route,
    post (pattern: string, handler: any): Route,
    put (pattern: string, handler: any): Route,
    patch (pattern: string, handler: any): Route,
    destroy (pattern: string, handler: any): Route,
